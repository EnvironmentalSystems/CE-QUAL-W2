...
ENTRY BIVALENTMN
  ...
  DO I=IU,ID
    DO K=KT,KB(I)
      ...
      ENDIF
      ENDIF
      MNIISR(K,I) = FEIIR(JW)*SODD(K,I)*DO2(K,I)
...
ENTRY DEALLOCATE_KINETICS
  ...
  IF(MIGRATION == 'ON')DEALLOCATE (ASETTLE, DEN_AVG, DENP, DEN1, DEN2, ALLIM_OLD, DEN, AMP, PHASE, C_COEFF_EXT, RAD, MIND, MAXD, DENSI, DENBI, T_DEC, C_DENINC, C_DENDEC, DEPTH_LIM, LOSS_FRAC, TWQ, &
      I_C, C_DENINC_1, C_DENINC_2, C_DENDEC_1, C_DENDEC_2, DENP_MINS, DENP_MINB, DENP_MIN, DEN_COR, MIGRATE_GROUP, MIGRATE_MODEL, TS_DEC, DEPTH_LIM_ONOFF, ALGAE_SETTLING,&

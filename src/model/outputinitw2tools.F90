...
IF(LAKE_RIVER_CONTOURC)THEN
  ...
  IF(LAKE_RIVER_CONTOUR_ON=='ON')THEN
          ...
          ELSE
          WRITE(LAKE_RIVER_CONTOUR+JJ-1,'("TIME,",1000(F8.2,","))')((EL(K,LAKE_CONTOUR_SEG(JJ))+EL(K,LAKE_CONTOUR_SEG(JJ)))*0.5,K=2,KB(LAKE_CONTOUR_SEG(JJ)))
          ENDIF
              ...
              ELSE
              WRITE(LAKE_RIVER_CONTOUR+10+JJ-1,'("TIME,",1000(F8.2,","))')((EL(K,LAKE_CONTOUR_SEG(JJ))+EL(K,LAKE_CONTOUR_SEG(JJ)))*0.5,K=2,KB(LAKE_CONTOUR_SEG(JJ)))
              ENDIF
              ENDIF
          ENDDO
          ...
          ELSE
          WRITE(LAKE_RIVER_CONTOUR+20+JJ-1,'("TIME,",1000(F8.2,","))')((X1(I),I=US(JB),DS(JB)),JB=RIVER_CONTOUR_BR1(JJ),RIVER_CONTOUR_BR2(JJ))
          ENDIF
              IF(OXYGEN_DEMAND)THEN
              WRITE(ICHAR3,'(I3)')LAKE_CONTOUR_SEG(JJ)
              ...
              ELSE
              WRITE(LAKE_RIVER_CONTOUR+30+JJ-1,'("TIME,",1000(F8.2,","))')((EL(K,LAKE_CONTOUR_SEG(JJ))+EL(K,LAKE_CONTOUR_SEG(JJ)))*0.5,K=2,KB(LAKE_CONTOUR_SEG(JJ)))
              ENDIF
              ENDIF
          ENDDO
    ENDIF  

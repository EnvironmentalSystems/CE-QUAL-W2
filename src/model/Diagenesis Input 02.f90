...
!                    Open(CEMASedFlxFilN12, File = 'Diagenesis_SD_JNH4.csv', POSITION='APPEND')
!                    REWIND (CEMASedFlxFilN12)  
!                    READ   (CEMASedFlxFilN12,'(/)',END=118)  
!                    DO WHILE (JDAY1 < JDAY)  
!                     READ (CEMASedFlxFilN12,'(A,F12.0)',END=118)ADUMMY, JDAY1  
!                    END DO  
!                    BACKSPACE (CEMASedFlxFilN12)  
!118                JDAY1 = 0.0                 
!                    Open(CEMASedFlxFilN12, File = 'Diagenesis_SD_JNH4.csv', POSITION='APPEND')
!                    REWIND (CEMASedFlxFilN12)  
!                    READ   (CEMASedFlxFilN12,'(/)',END=119)  
!                    DO WHILE (JDAY1 < JDAY)  
!                     READ (CEMASedFlxFilN12,'(A,F12.0)',END=119)ADUMMY, JDAY1  
!                    END DO  
!                    BACKSPACE (CEMASedFlxFilN12)  
!119                JDAY1 = 0.0                 

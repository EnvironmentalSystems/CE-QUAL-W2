...
! Variable declarations
  ...
  CHARACTER(80):: FILE_LAKE_CONTOUR_T(10),FILE_LAKE_CONTOUR_DO(10),FILE_RIVER_CONTOUR_T(10),FILE_RIVER_CONTOUR_DO(10)
  INTEGER      :: NUM_LAKE_CONTOUR,NUM_RIVER_CONTOUR,LAKE_CONTOUR_SEG(10),RIVER_CONTOUR_BR1(10),RIVER_CONTOUR_BR2(10)
  INTEGER      :: JW_RIVER_CONTOUR(10), JW_LAKE_CONTOUR(10),LAKE_CONTOUR_FORMAT,RIVER_CONTOUR_FORMAT
  REAL         :: LAKE_CONTOUR_START(10),LAKE_CONTOUR_FREQ(10),RIVER_CONTOUR_START(10),RIVER_CONTOUR_FREQ(10),NXT_RIVER_CONTOUR(10), NXT_LAKE_CONTOUR(10)
...
ELSE
  ...
  READ (CON,*,ERR=400) NWB, NBR, IMX, KMX, NPROC, CLOSEC; CLOSEC=ADJUSTR(CLOSEC)                   !'(A,5I0,A)'  
  READ (CON,*,ERR=400)
  READ (CON,*,ERR=400) AID
  IF (AID /= 'NTR     ') THEN
      AID1='NTR     ';ICST=3
  ...
  ! Constrictions                       ! SW 8/5/2018
   ...
   WRITE (WIN,*) 'Constriction File Check'
    ...
    IF(CONSTRICTION)THEN
        ...
        READ(NPT,*)
        READ(NPT,*)ICON    ! NUMBER OF CONSTRICTIONS
        IF (ICON >= IMX) THEN
        CALL ERRORS
...
! Initial input and conditions
  ...
  IF(SED_DIAG=='      ON'.AND.DIAG_EXISTS)THEN
        ...
        if(IncludeManganese)WRITE(INI,'(T20,A)')'Sediment Mn processes are OFF'
